...
app.controller('teamsController', ['$scope', '$state', '$stateParams', 'teamService', 'playerService', teamsController]);

function teamsController($scope, $state, $stateParams, teamService, playerService) {
